...
def _show_prerequisite_dialog():
    ...
    label.setText(
        ...
        <ul>
            ...
            <li>La cartella <b>stili</b>, se disponibile, deve trovarsi nella cartella del progetto.</li>
        </ul>
...
class ComuneAutocompleteWidgetWrapper(WidgetWrapper):
    ...
    def createWidget(self):
        ...
        self._line_edit.setPlaceholderText(
            "Digita il Comune, es. Tromello. Seleziona un valore esatto tra quelli proposti."
        )
...
class AnalisiDusaf7ComuneLombardo(QgsProcessingAlgorithm):
    ...
    def createInstance(self):
        return AnalisiDusaf7ComuneLombardo()
    ...
    def _style_path(self, project_dir, style_filename):
        return os.path.join(project_dir, STYLE_FOLDER_NAME, style_filename)
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        self._msg(feedback, f"[OK] Cartella stili attesa: {style_dir}")
        ...
        if not os.path.isdir(style_dir):
            self._warn(
                feedback,
                f"[STYLE WARNING] Cartella stili non trovata: {style_dir}. "
